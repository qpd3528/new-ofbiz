  ...
  <fo:page-sequence master-reference="main">
    <fo:flow flow-name="xsl-region-body" font-family="Helvetica">
      ...
      <fo:block text-align="center">
        ...
        <fo:external-graphic
            src="/business/control/qrcode;jsessionid=${session.id}?message=${business.businessName?url}&amp;format=bmp&amp;encoding=UTF-8&amp;verifyOutput=true&amp;logoImageMaxWidth=20&amp;logoImageMaxHeight=20"
