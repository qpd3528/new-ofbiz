...
// Useful variables with business values:
// controlPath ->= /business/control
// contextRoot -> C:\dev\floss\ofbiz\ofbiz-framework\plugins\business\webapp\business\
// serverRoot -> https://localhost:8443
// context.application.context.context.path -> /business

// Path component of URL leading to the servlet mount point, e.g. '/business'.
String contextUrlPath = context.application.context.context.path
// Filesystem path to the webapp root, e.g. '$ofbiz-framework/plugins/business/webapp/business/'.
