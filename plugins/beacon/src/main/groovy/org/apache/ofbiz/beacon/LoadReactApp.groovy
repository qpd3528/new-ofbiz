...
// Useful variables with beacon values:
// controlPath ->= /beacon/control
// contextRoot -> C:\dev\floss\ofbiz\ofbiz-framework\plugins\beacon\webapp\beacon\
// serverRoot -> https://localhost:8443
// context.application.context.context.path -> /beacon

// Path component of URL leading to the servlet mount point, e.g. '/beacon'.
String contextUrlPath = context.application.context.context.path
// Filesystem path to the webapp root, e.g. '$ofbiz-framework/plugins/beacon/webapp/beacon/'.
