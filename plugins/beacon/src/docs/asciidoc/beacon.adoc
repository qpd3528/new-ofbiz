...
The Beacon application will allow you to discover the possibilities to create an application, with a lot of search boxes,
lists and many more.

This application could be used to have an beacon of the bests practices in user interface development in Apache - OFBiz.

Look help for each beacon screen, help will explain which part of development is used in this case.

For beacon, if you want to see how you should do to add some help you can look to help files in src/docs/asciisoc/_include/
directory and src/docs/asciisoc/beacon.adoc both in beacon component.
...
To have the complete list you should click on index button and look to beacon tree option, but here is a list of
main shortcut :
...
include::_include/beacon_main.adoc[leveloffset=+2]
